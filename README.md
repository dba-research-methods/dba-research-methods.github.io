...
| `rq-lab.html` | **RQ Lab** — problem-mining workbook. Reads Walmart's supply chain as evidence rather than a success story, separates implementation challenges from research gaps, and produces three researchable problems with the designs that would answer them. 17 sections, 17 figures, 38 sources. |
